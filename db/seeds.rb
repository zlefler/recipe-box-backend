...
Heat a cast-iron skillet to medium-high heat and place the sandwiches in the pan. Top with a second cast-iron skillet to weigh the sandwiches down. After 2 minutes, turn down the heat to medium low, flip the sandwiches and weigh down again with the second skillet. Check the sandwiches after 1 more minute, and remove when golden brown and the cheese has melted.', time_to_make: '30', vegetarian: false, user_id: 2)
Recipe.create(name: 'Spanish Rice Fritatta', instructions: 'Chop onion and peppers. Melt butter or margarine in a skillet and sauté onion and pepper over medium heat until tender. Stir often.
    ...
    Pour into casserole dish and bake in hot oven until firm (about 35 minutes).', time_to_make: 35, vegetarian: true, user_id: 1)
